...
export default function TC_C() {
    ...
    return (
        <Wrapper>
            ...
            <p>We employ the use of cookies. By accessing {contact.name} investment, you agreed to use cookies in agreement with the {contact.name} Investment's Privacy Policy.</p>
            ...
            <p>Unless otherwise stated, {contact.name} Investment and/or its licensors own the intellectual property rights for all material on {contact.name} investment. All intellectual property rights are reserved. You may access this from {contact.name} investment for your own personal use subjected to restrictions set in these terms and conditions.</p>

            <p>You must not:</p>

            <ul>
                <li>Republish material from {contact.name} investment</li>
                <li>Sell, rent or sub-license material from {contact.name} investment</li>
                <li>Reproduce, duplicate or copy material from {contact.name} investment</li>
            ...
            <p>{contact.name} Investment reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.</p>
            ...
            <p>You hereby grant {contact.name} Investment a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</p>
            ...
            <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look unfavorably to ourselves or to our accredited businesses; (b) the organization does not have any negative records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of {contact.name} Investment; and (d) the link is in the context of general resource information.</p>
            ...
            <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you must inform us by sending an e-mail to {contact.name} Investment. Please include your name, your organization name, contact information as well as the URL of your site, a list of any URLs from which you intend to link to our Website, and a list of the URLs on our site to which you would like to link. Wait 2-3 weeks for a response.</p>
            ...
            <p>No use of {contact.name} Investment's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
...
const Wrapper = styled.div`
    text-align: justify;
    padding-left: ${({ theme }) => theme.lg_padding};
    padding-right: ${({ theme }) => theme.lg_padding};
    padding-top: 10px;
    padding-bottom: 30px;

    @media (max-width: ${({ theme }) => theme.md_screen}){
        padding-left: ${({ theme }) => theme.md_padding};
        padding-right: ${({ theme }) => theme.md_padding};
        padding-top: 10px;
        padding-bottom: 30px;
    }
    @media (max-width: ${({ theme }) => theme.sm_screen}){
        padding-left: ${({ theme }) => theme.sm_padding};
        padding-right: ${({ theme }) => theme.sm_padding};
        padding-top: 10px;
        padding-bottom: 30px;
    }
